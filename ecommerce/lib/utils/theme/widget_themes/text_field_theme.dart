...
class AppTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle()
        .copyWith(fontSize: AppSizes.fontMd, color: AppColors.black),
    hintStyle: const TextStyle()
        .copyWith(fontSize: AppSizes.fontSm, color: AppColors.black),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    // constraints: const BoxConstraints.expand(height: AppSizes.inputFieldHeight),
    labelStyle: const TextStyle()
        .copyWith(fontSize: AppSizes.fontMd, color: AppColors.white),
    hintStyle: const TextStyle()
        .copyWith(fontSize: AppSizes.fontSm, color: AppColors.white),
    floatingLabelStyle:
